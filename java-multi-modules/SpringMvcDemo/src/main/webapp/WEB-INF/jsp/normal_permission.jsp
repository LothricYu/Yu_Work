...
<%@ page import="springmessage.pojo.Permissionrole" %>
...
%>
<%
    Permissionrole permission= (Permissionrole) request.getSession().getAttribute("normal_permission");

%>
<center>
    <form action="/normal_per" method="post">
        角色权限：
